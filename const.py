...
Cnoiseless_opt_file = f'{datadir}/Cnl_opt.txt'
data280_file = f'{datadir}/data280.npy'
kernel280_file = f'{datadir}/kernel280.npy'
C_noise_5_opt_file = f'{datadir}/Cn_5_opt.txt'
C_noise_7_opt_file = f'{datadir}/Cn_7_opt.txt'
C_noise_10_opt_file = f'{datadir}/Cn_10_opt.txt'
